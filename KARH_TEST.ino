 ...
 void GAME2(){
  ...
  if(digitalRead(button)==LOW){
   ...
   // lcd.drawBitmap(0,0,elsys,84,84);
    ...
    lcd.drawBitmap(30,10,enm,10,8);
    //WAT>>>!!!?
      if (fire>=1){//TUKA SA STRELYA
       lcd.drawLine(shotpos1, 42-dvijenie_na_shota_v_game_2[0],shotpos1 , 39-dvijenie_na_shota_v_game_2[0]);
    }
    /* if (fire>=2){//TUKA SA STRELYA
       lcd.drawLine(shotpos1, 42-dvijenie_na_shota_v_game_2[1],shotpos1 , 39-dvijenie_na_shota_v_game_2[1]);
    }
     if (fire>=3){//TUKA SA STRELYA
       lcd.drawLine(shotpos1, 42-dvijenie_na_shota_v_game_2[2],shotpos1 , 39-dvijenie_na_shota_v_game_2[2]);
    }*/
    lcd.update();
